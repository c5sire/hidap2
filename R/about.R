...
about <- function(title = "About"){
  ...
  p(class = "text-muted", style="text-align:justify",
    paste("HIDAP is a tool designed to help breeders of clonal crop (like potato and sweetpotato) to carry out field trial planning, documentation, analysis and reporting.")
  ),
  fluidRow(
